...
public class Cliquey_Clicker_Gamma_0_0_0 extends PApplet {
...
public void mouseReleased(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Cliquey_Clicker_Gamma_0_0_0" };
    if (passedArgs != null) {
