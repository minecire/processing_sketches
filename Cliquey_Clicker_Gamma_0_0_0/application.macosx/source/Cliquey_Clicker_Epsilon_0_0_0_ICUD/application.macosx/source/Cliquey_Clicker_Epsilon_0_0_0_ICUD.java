...
public class Cliquey_Clicker_Epsilon_0_0_0_ICUD extends PApplet {
...
public int logten(double apple){
  w = 0;
  while(apple>10){
    apple/=10;
    w+=1;
...
public void draw() {
  ...
  text("Cliquey Clicker!",200-((animationPoint-150)*1.8f), (animationPoint-150)*4);
  ...
  rect(360-(animationPoint-40)*8,200+(animationPoint-40),100,50);
    ...
    fill(0,0,255);
    rect(40+(animationPoint-80)*1.5f,240-(animationPoint-80)*3,100,50);
  }
  }
  else if(start == true){
    if(keyPressed){
    ...
    CP = ((mice*(miceCPS)) + (buttons*5*(buttonCPS)) + (games*10*(clickerCPS)) + (machs * 50*(machCPS)) + (farms*200*(farmCPS)) + (facts*1000*(factCPS)) + (cmen*50000*(cmanCPS)) + (planets*200000*(planetCPS)) + (cloners*1000000*(clonerCPS)) + (whiteholes*5000000*(whiteholeCPS)))*((numberofachcheck()+100.0f)/100.0f);
    ...
    text("Times "+String.format("%.2f",((numberofachcheck()+100.0f)/100.0f))+" boost",50,90);
    fill(0,0,255);
    ...
    ellipse(50,(400 + hour()-((floor(hour()/6.0f))*6)*(-30) - minute()/2),50,50);
    }
    else{
    ...
    if(thing == 50){
    clix+=mice*miceCPS*((numberofachcheck()+100.0f)/100.0f);
    thing = 0;
    saveStuff();
    }
    if(thing == 0 || thing == 10 || thing == 20 || thing == 30 || thing == 40){
      clix+=buttons*buttonCPS*((numberofachcheck()+100.0f)/100.0f);
    }
    if(thing == 0 || thing == 5 || thing == 10 || thing == 15 || thing == 20 || thing == 25 || thing == 30 || thing == 35 || thing == 40 || thing == 45){
      clix+=games*clickerCPS*((numberofachcheck()+100.0f)/100.0f);
    }
    clix+=machs*machCPS*((numberofachcheck()+100.0f)/100.0f);
    clix+=(farms*4*farmCPS*((numberofachcheck()+100.0f)/100.0f));
    clix+=(facts*20*factCPS*((numberofachcheck()+100.0f)/100.0f));
    clix+=(cmen*100*cmanCPS*((numberofachcheck()+100.0f)/100.0f));
    clix+=(planetCPS*4000*planets*((numberofachcheck()+100.0f)/100.0f));
    clix+=(clonerCPS*20000*cloners*((numberofachcheck()+100.0f)/100.0f));
    clix+=(whiteholeCPS*100000*whiteholes*((numberofachcheck()+100.0f)/100.0f));
    fill(0);
    if(style == 4){
      fill(100);
    }
...
public void mouseReleased(){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Cliquey_Clicker_Epsilon_0_0_0_ICUD" };
    if (passedArgs != null) {
