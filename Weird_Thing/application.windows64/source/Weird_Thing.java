...
public class Weird_Thing extends PApplet {
...
int l = 0;
float ml = 1;
public void sqp(float x,float y,float w){
...
public void draw(){
  for(int i = 0; i < ((grid.size()*1.1f)+2)/2; i++){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Weird_Thing" };
    if (passedArgs != null) {
