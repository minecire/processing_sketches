  ...
  rect(360-(animationPoint-40)*8,200+(animationPoint-40),100,50);
    ...
    if(mouseX>300){
      ...
      if(mouseY<50+scrolly){
        ...
        if(buttonCPS < 1000000){
        text("+"+String.format("%.2f",buttonCPS)+" CPS per button",20,340);
        }
        else{
          text("+"+String.format("%4f",buttonCPS/pow(10,floor(logten(buttonCPS))))+"x10^"+floor(logten(buttonCPS))+" CPS per button",20,340);
        }
        if(miceUGprice < 1000000){
        ...
        if(clickerCPS < 1000000){
        text("+"+String.format("%.2f",clickerCPS)+" CPS per clicker game",20,340);
        }
        else{
          text("+"+String.format("%4f",clickerCPS/pow(10,floor(logten(clickerCPS))))+"x10^"+floor(logten(clickerCPS))+" CPS per clicker game",20,340);
        }
        ...
        if(machCPS < 1000000){
        text("+"+String.format("%.2f",machCPS)+" CPS per machine",20,340);
        }
        else{
          text("+"+String.format("%4f",machCPS/pow(10,floor(logten(machCPS))))+"x10^"+floor(logten(machCPS))+" CPS per machine",20,340);
        }
        ...
        if(farmCPS < 1000000){
        text("+"+String.format("%.2f",farmCPS)+" CPS per farm",20,340);
        }
        else{
          text("+"+String.format("%4f",farmCPS/pow(10,floor(logten(farmCPS))))+"x10^"+floor(logten(farmCPS))+" CPS per farm",20,340);
        }
        ...
        if(factCPS < 1000000){
        text("+"+String.format("%.2f",factCPS)+" CPS per Factory",20,340);
        }
        else{
          text("+"+String.format("%4f",factCPS/pow(10,floor(logten(factCPS))))+"x10^"+floor(logten(factCPS))+" CPS per Factory",20,340);
        }
        ...
        if(cmanCPS < 1000000){
        text("+"+String.format("%.2f",cmanCPS)+" CPS per Clicker Man",20,340);
        }
        else{
          text("+"+String.format("%4f",cmanCPS/pow(10,floor(logten(cmanCPS))))+"x10^"+floor(logten(cmanCPS))+" CPS per Clicker Man",20,340);
        }
        ...
        if(planetCPS < 1000000){
        text("+"+String.format("%.2f",planetCPS)+" CPS per Planet",20,340);
        }
        else{
          text("+"+String.format("%4f",planetCPS/pow(10,floor(logten(planetCPS))))+"x10^"+floor(logten(planetCPS))+" CPS per Planet",20,340);
        }
        ...
        if(clonerCPS < 1000000){
        text("+"+String.format("%.2f",clonerCPS)+" CPS per Cloner",20,340);
        }
        else{
          text("+"+String.format("%4f",clonerCPS/pow(10,floor(logten(clonerCPS))))+"x10^"+floor(logten(clonerCPS))+" CPS per Cloner",20,340);
        }
        ...
        if(whiteholeCPS < 1000000){
        text("+"+String.format("%.2f",whiteholeCPS)+" CPS per White Hole",20,340);
        }
        else{
          text("+"+String.format("%4f",whiteholeCPS/pow(10,floor(logten(whiteholeCPS))))+"x10^"+floor(logten(whiteholeCPS))+" CPS per White Hole",20,340);
        }
