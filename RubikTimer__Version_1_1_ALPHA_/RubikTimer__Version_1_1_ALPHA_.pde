...
void drawTime(){ //make a function to draw when screen is time
  if(puzzle == "2x2"){
    textSize(25);
  }
  if(puzzle == "3x3"){
...
void drawChart(){
  ...
  for(int i = 0; i < 10; i++){
    text(round(times2.min()+ch*i)+"-"+round(times2.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "3x3"){
  if(times3.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(times3.min()+ch*i)+"-"+round(times3.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "4x4"){
  if(times4.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(times4.min()+ch*i)+"-"+round(times4.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "5x5"){
  if(times5.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(times5.min()+ch*i)+"-"+round(times5.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "6x6"){
  if(times6.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(times6.min()+ch*i)+"-"+round(times6.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "7x7"){
  if(times7.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(times7.min()+ch*i)+"-"+round(times7.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "8x8"){
  if(times8.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(times8.min()+ch*i)+"-"+round(times8.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "9x9"){
  if(times9.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(times9.min()+ch*i)+"-"+round(times9.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "10x10"){
  if(times10.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(times10.min()+ch*i)+"-"+round(times10.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "11x11"){
  if(times11.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(times11.min()+ch*i)+"-"+round(times11.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "13x13"){
  if(times13.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(times13.min()+ch*i)+"-"+round(times13.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "Pyraminx"){
  if(timesPy.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(timesPy.min()+ch*i)+"-"+round(timesPy.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "Skewb"){
  if(timesSk.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(timesSk.min()+ch*i)+"-"+round(timesSk.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "Megaminx"){
  if(timesMm.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(timesMm.min()+ch*i)+"-"+round(timesMm.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "Clock"){
  if(timesCl.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(timesCl.min()+ch*i)+"-"+round(timesCl.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "Magic"){
  if(timesMag.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(timesMag.min()+ch*i)+"-"+round(timesMag.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "Master Pyraminx"){
  if(timesMpy.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(timesMpy.min()+ch*i)+"-"+round(timesMpy.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "Professor Pyraminx"){
  if(timesPpy.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(timesPpy.min()+ch*i)+"-"+round(timesPpy.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "Gigaminx"){
  if(timesGm.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(timesGm.min()+ch*i)+"-"+round(timesGm.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "Teraminx"){
  if(timesTm.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(timesTm.min()+ch*i)+"-"+round(timesTm.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
  if(puzzle == "Petaminx"){
  if(timesPm.size() > 0){
  ...
  rect(100,9*height/10,(width-80)*ch10/chmax,height/11);
  for(int i = 0; i < 10; i++){
    text(round(timesPm.min()+ch*i)+"-"+round(timesPm.min()+ch*(i+1)),30,(i+0.5)*height/10);
  }
  }
}
void keyReleased(){
...
FloatList ss(FloatList list, int end){
...
void newScramble(){
  ...
  for(int i = 0; i < 50; i++){
  String ad = "";
  int move = floor(random(1,19));
  while(move == prem){
  move = floor(random(1,19));
  }
  int direction = floor(random(1,4));
  if(move == 1){
    ad+="R";
